...
const essayEvaluationSchema = new mongoose_1.Schema({
    essaySubmissionId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'EssaySubmission', required: true, unique: true },
...
exports.default = mongoose_1.default.model('EssayEvaluation', essayEvaluationSchema);
//# sourceMappingURL=EssayEvaluation.js.map