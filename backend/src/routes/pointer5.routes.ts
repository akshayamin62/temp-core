...
router.post('/task', authorize(USER_ROLE.IVY_EXPERT), uploadAttachmentsMiddleware, createTaskHandler);
router.put('/task', authorize(USER_ROLE.IVY_EXPERT), uploadAttachmentsMiddleware, updateTaskHandler);
router.delete('/task/:taskId', authorize(USER_ROLE.IVY_EXPERT), deleteTaskHandler);
...
router.post('/evaluate', authorize(USER_ROLE.IVY_EXPERT), evaluateSubmissionHandler);
