...
router.get('/activity/student/:studentId', authorize([USER_ROLE.IVY_EXPERT, USER_ROLE.STUDENT, USER_ROLE.SUPER_ADMIN, USER_ROLE.ADMIN, USER_ROLE.COUNSELOR, USER_ROLE.PARENT, USER_ROLE.ADVISORY]), checkAdvisoryStudentAccess, getStudentActivitiesHandler);
...
router.post('/activity/proof/upload', authorize([USER_ROLE.STUDENT, USER_ROLE.SUPER_ADMIN]), uploadProofMiddleware, uploadProofHandler);

// POST /pointer/activity/evaluate - Ivy Expert evaluates activity
router.post('/activity/evaluate', authorize([USER_ROLE.IVY_EXPERT, USER_ROLE.SUPER_ADMIN]), evaluateActivityHandler);
