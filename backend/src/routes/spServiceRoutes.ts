...
router.get('/student/:studentId/enquiries', authenticate, authorize([USER_ROLE.SUPER_ADMIN, USER_ROLE.ADMIN, USER_ROLE.PARENT, USER_ROLE.REFERRER, USER_ROLE.ADVISOR]), getStudentEnquiriesById);
