...
router.post('/evaluate', authorize(USER_ROLE.IVY_EXPERT), evaluateAcademicHandler);
...
router.post('/academic/section', authorize([USER_ROLE.IVY_EXPERT, USER_ROLE.STUDENT]), addSectionHandler);

// POST /api/pointer1/academic/subsection - Add a sub-section
router.post('/academic/subsection', authorize([USER_ROLE.IVY_EXPERT, USER_ROLE.STUDENT]), addSubSectionHandler);

// PUT /api/pointer1/academic/subsection - Update a sub-section
router.put('/academic/subsection', authorize([USER_ROLE.IVY_EXPERT, USER_ROLE.STUDENT]), updateSubSectionHandler);

// POST /api/pointer1/academic/subject - Add a subject
router.post('/academic/subject', authorize([USER_ROLE.IVY_EXPERT, USER_ROLE.STUDENT]), addSubjectHandler);

// PUT /api/pointer1/academic/subject - Update a subject
router.put('/academic/subject', authorize([USER_ROLE.IVY_EXPERT, USER_ROLE.STUDENT]), updateSubjectHandler);

// DELETE /api/pointer1/academic/section - Delete a section
router.delete('/academic/section', authorize([USER_ROLE.IVY_EXPERT, USER_ROLE.STUDENT]), deleteSectionHandler);

// DELETE /api/pointer1/academic/subsection - Delete a sub-section
router.delete('/academic/subsection', authorize([USER_ROLE.IVY_EXPERT, USER_ROLE.STUDENT]), deleteSubSectionHandler);

// DELETE /api/pointer1/academic/subject - Delete a subject
router.delete('/academic/subject', authorize([USER_ROLE.IVY_EXPERT, USER_ROLE.STUDENT]), deleteSubjectHandler);

// PUT /api/pointer1/academic/weightages - Update weightages for informal sections
router.put('/academic/weightages', authorize([USER_ROLE.IVY_EXPERT, USER_ROLE.STUDENT]), updateWeightagesHandler);
