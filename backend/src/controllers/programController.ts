...
export const getOpsStudentPrograms = async (req: AuthRequest, res: Response): Promise<Response> => {
  try {
    ...
    // Allow OPS, ADMIN, COUNSELOR, SUPER_ADMIN, PARENT, EDUPLAN_COACH, IVY_EXPERT, REFERRER roles
    const allowedRoles = [USER_ROLE.OPS, USER_ROLE.ADMIN, USER_ROLE.COUNSELOR, USER_ROLE.SUPER_ADMIN, USER_ROLE.PARENT, USER_ROLE.EDUPLAN_COACH, USER_ROLE.IVY_EXPERT, USER_ROLE.REFERRER];
