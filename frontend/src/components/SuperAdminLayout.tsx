...
export default function SuperAdminLayout({ children, user }: SuperAdminLayoutProps) {
  ...
  const navigationItems: NavItem[] = [
    ...
    },
    {
      ...
      path: '/super-admin/roles/advisory',
    },
    {
      name: 'Ops',
      icon: Icons.ops,
    ...
    },
    {
      ...
      path: '/super-admin/roles/counselor',
    },
    {
      name: 'Student',
      icon: Icons.student,
      path: '/super-admin/roles/student',
    },
    {
      name: 'Parents',
      icon: Icons.parent,
      path: '/super-admin/roles/parent',
    },
    {
      name: 'Alumni',
      icon: Icons.alumni,
      path: '/super-admin/roles/alumni',
    },
    {
      ...
      return (
        <div key={item.name}>
          <button
            ...
            className={`w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition-all text-gray-700 hover:bg-gray-100 ${
