...
export default function IvyExpertLayout({ children, user }: IvyExpertLayoutProps) {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      path: '/ivy-league/ivy-expert/candidates',
    },
    {
      name: 'Ivy Students',
      icon: (
      ...
      path: '/ivy-league/ivy-expert/students',
    },
    {
      name: 'Parents',
      icon: (
      ...
      path: '/ivy-league/ivy-expert/parents',
    },
    {
      name: 'Alumni',
      icon: (
      ...
      path: '/ivy-league/ivy-expert/alumni',
    },
    {
      ...
      path: '/ivy-league/ivy-expert/service-providers',
    },
    {
      name: 'Learning Hub',
      icon: (
    ...
    },
    {
      ...
      path: '/ivy-league/ivy-expert/archive',
    },
  ];
  ...
  const isActive = (path: string) => {
    if (path === '/ivy-league/ivy-expert') return pathname === path;
        ...
        <div className="h-16 border-b border-gray-200 flex items-center justify-between px-4">
          {sidebarOpen && (
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-gray-900">Ivy Expert</span>
            </div>
          )}
          <button
