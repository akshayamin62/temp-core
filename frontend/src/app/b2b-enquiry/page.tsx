        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-10 max-w-md w-full text-center">
            ...
            {/* <button
              onClick={() => {
                setSubmitted(false);
                setFormData({ firstName: '', middleName: '', lastName: '', email: '', mobileNumber: '', city: '', type: B2B_LEAD_TYPE.FRANCHISE });
              }}
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  { value: B2B_LEAD_TYPE.INSTITUTION, label: 'Institution', desc: 'Institutional Partner' },
                  { value: B2B_LEAD_TYPE.ADVISOR, label: 'Advisor', desc: 'Be our advisor' },
                ].map((option) => (
                  <label
                    key={option.value}
