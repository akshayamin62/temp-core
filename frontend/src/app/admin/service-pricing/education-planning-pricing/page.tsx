...
export default function EducationPlanningPricingPage() {
    ...
    <AdminLayout user={user}>
      ...
      <div className="bg-gradient-to-b from-slate-50 via-white to-slate-50 min-h-[calc(100vh-5rem)]">
        ...
        <div className="p-6 lg:p-8">
          ...
          {/* Info Note */}
          <div className="mt-8 bg-gradient-to-r from-teal-50 to-emerald-50 border border-teal-200 rounded-2xl p-5 shadow-sm">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-teal-700 mt-1">The <strong>base price</strong> is what you pay to the platform (set by Super Admin). The <strong>selling price</strong> you set here is what your students see. The difference is your profit margin.</p>
              </div>
            </div>
          </div>
        </div>
