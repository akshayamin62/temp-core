...
export default function SuperAdminViewAdminPricingPage() {
  ...
  return (
    <SuperAdminLayout user={user}>
      ...
      <div className="p-6 lg:p-8">
        <button onClick={() => router.push(`/super-admin/roles/admin/${adminId}`)} className="mb-6 inline-flex items-center gap-1.5 text-sm text-gray-600 hover:text-gray-900 transition-colors font-medium">
        ...
        {!selectedService && (
          <>
            <div className="mb-8">
              <h1 className="text-2xl font-bold text-gray-900">Admin Service Pricing</h1>
              <p className="text-gray-500 mt-1">View this admin&apos;s selling prices for each service plan.</p>
            </div>
            ...
            {loadingPlans ? (
              ...
              <>
                <div className="bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 text-white rounded-2xl p-8 mb-8 relative overflow-hidden">
                  ...
                  <h2 className="text-2xl lg:text-3xl font-extrabold tracking-tight relative">{selectedServiceInfo?.name} — Admin Pricing</h2>
                  <p className="mt-2 text-blue-200 text-lg max-w-2xl relative">This admin&apos;s selling prices for each plan.</p>
                </div>
                ...
                <ServicePlanDetailsView
                  ...
                  showPricing={true}
                  noPricingMessage="This admin has not set pricing yet."
                />
              </>
            )}
          </div>
