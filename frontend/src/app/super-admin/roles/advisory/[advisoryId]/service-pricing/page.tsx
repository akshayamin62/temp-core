...
const availableServices = [
  { slug: 'study-abroad', name: 'Study Abroad', description: 'View this advisory\'s pricing for Study Abroad plans.', icon: '🌍' },
  { slug: 'education-planning', name: 'Education Planning', description: 'View this advisory\'s pricing for Education Planning plans.', icon: '🎓' },
  { slug: 'coaching-classes', name: 'Coaching Classes', description: 'View this advisory\'s pricing for Coaching Classes.', icon: '📚' },
];

export default function SuperAdminViewAdvisoryPricingPage() {
  ...
  const handleSelectService = async (slug: string) => {
    ...
    try {
      const pricingRes = await servicePlanAPI.getAdminPricingById(slug, advisoryId);
        ...
        {selectedService && (
          <div>
            ...
            {loadingPlans ? (
              ...
              <>
                <div className="mb-8">
                  <h2 className="text-2xl lg:text-3xl font-extrabold text-gray-900 tracking-tight">Coaching Fees — Advisory Pricing</h2>
                  <p className="mt-1 text-gray-500 text-lg max-w-2xl">This advisory&apos;s selling prices for each coaching class.</p>
                </div>
                  ...
                  <div className="mb-8 bg-amber-50/80 backdrop-blur border border-amber-200 rounded-2xl p-5">
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-amber-700 mt-0.5">This advisory has not set pricing yet.</p>
                      </div>
                    </div>
                  </div>
                )}
              ...
              <>
                <div className="bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 text-white rounded-2xl p-8 mb-8 relative overflow-hidden">
                  ...
                  <h2 className="text-2xl lg:text-3xl font-extrabold tracking-tight relative">{selectedServiceInfo?.name} — Advisory Pricing</h2>
                  <p className="mt-2 text-blue-200 text-lg max-w-2xl relative">This advisory&apos;s selling prices for each plan.</p>
                </div>
                ...
                <ServicePlanDetailsView
                  ...
                  showPricing={true}
                  noPricingMessage="This advisory has not set pricing yet."
                />
              </>
            )}
          </div>
