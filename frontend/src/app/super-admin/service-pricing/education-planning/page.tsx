...
export default function SuperAdminEducationPlanningPricingPage() {
  ...
  const fetchPricing = async () => {
    try {
      const res = await servicePlanAPI.getSuperAdminPricing('education-planning');
  ...
  const handlePriceEdit = async (planKey: string, price: number) => {
    ...
    try {
      const res = await servicePlanAPI.setSuperAdminPricing('education-planning', currentPrices);
