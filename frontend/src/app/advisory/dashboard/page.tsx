...
import { authAPI, advisoryAPI, teamMeetAPI } from '@/lib/api';
...
export default function AdvisoryDashboardPage() {
  ...
  const fetchStats = async () => {
    try {
      const response = await advisoryAPI.getDashboardStats();
  ...
  const fetchEnquiryUrl = async () => {
    try {
      const response = await advisoryAPI.getEnquiryFormUrl();
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <ActionCard
                ...
                onClick={() => router.push('/advisory/students')}
                color="blue"
              />
              <ActionCard
                ...
                onClick={() => router.push('/advisory/service-pricing')}
                color="blue"
              />
            </div>
          </div>
