...
export default function EduplanCoachStudentDetailPage() {
  ...
  const educationPlanningRegistrations = registrations.filter(r => r.serviceId.name === 'Education Planning');
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            {educationPlanningRegistrations.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">No Education Planning registrations yet</p>
              </div>
            )}
          </div>
