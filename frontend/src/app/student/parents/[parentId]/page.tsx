...
export default function StudentParentDetailPage() {
  ...
  if (!parent) return (
    <StudentLayout formStructure={[]} currentPartIndex={0} currentSectionIndex={0} onPartChange={() => {}} onSectionChange={() => {}} isOuterNav={true} serviceName="Study Abroad" user={user}>
      <div className="p-8">
