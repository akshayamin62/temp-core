...
export default function ReferrerLeadsPage() {
  ...
  // Stats (always from allLeads so they don't change on filter)
    ...
    <>
      ...
      <ReferrerLayout user={user}>
        <div className="p-8">
          {/* Header */}
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-900">My Referred Leads</h1>
            <p className="text-gray-600 mt-1">View leads that came through your referral link</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            {leads.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">Share your referral link to start receiving leads</p>
              </div>
            ) : (
                    ...
                    {filteredLeads.map((lead) => (
                      <tr key={lead._id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-4 text-center">
                          <button
                            onClick={() => router.push(`/referrer/leads/${lead._id}`)}
