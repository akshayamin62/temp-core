/**
 * Hardcoded form structure configuration for frontend.
 * This replaces the dynamic form structure fetched from API.
 * 
...
export const PROFILE_CONFIG: PartConfig = {
  ...
  sections: [
    ...
    },
    {
      ...
      subSections: [
        {
          key: "ielts", title: "IELTS", order: 1, isRepeatable: false,
          fields: [
        ...
        {
          key: "gre", title: "GRE", order: 2, isRepeatable: false,
          fields: [
        ...
        {
          key: "sat", title: "SAT", order: 3, isRepeatable: false,
          fields: [
        ...
        {
          key: "pte", title: "PTE", order: 4, isRepeatable: false,
          fields: [
        ...
        {
          key: "toefl", title: "TOEFL", order: 5, isRepeatable: false,
          fields: [
        ...
        {
          key: "gmat", title: "GMAT", order: 6, isRepeatable: false,
          fields: [
        ...
        {
          key: "duolingo", title: "Duolingo", order: 7, isRepeatable: false,
          fields: [
...
export function getSectionConfig(partKey: FormPartKey, sectionKey: string): SectionConfig | undefined {
  return getPartConfig(partKey)?.sections.find(s => s.key === sectionKey);
}
...
export function getSubSectionConfig(partKey: FormPartKey, sectionKey: string, subSectionKey: string): SubSectionConfig | undefined {
  return getSectionConfig(partKey, sectionKey)?.subSections.find(ss => ss.key === subSectionKey);
}
